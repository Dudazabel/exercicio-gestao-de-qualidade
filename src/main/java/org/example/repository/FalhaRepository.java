...
public class FalhaRepository {
    ...
    public List<Falha> listaFalhaCriticaAberta() throws SQLException{
    ...
    public boolean falhaExiste(Long id) throws SQLException{
        String query = "SELECT status FROM Falha WHERE id = ?";
    ...
    public Falha buscarFalhaID(Long id) throws SQLException{
        String query = "SELECT id, equipamentoId, dataHoraOcorrencia, descricao, criticidade, status, tempoParadaHoras FROM Falha WHERE id = ?";
